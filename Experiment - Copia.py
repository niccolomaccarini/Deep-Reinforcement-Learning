...
def average_over_repetitions(backup, n_repetitions, n_timesteps, max_episode_length, learning_rate, gamma, policy='egreedy', #remove backup, it's not necessary to solve cartpole
    ...
    for rep in range(n_repetitions): # Loop over repetitions
        ...
        #write function to solve the cartpole problem, the same inputs can be used, must return list of rewards
...
def experiment():
    ...
    gamma = 1.0                 #set to 0.95

    # Exploration
    policy = 'egreedy' # 'egreedy' or 'softmax' 
    epsilon = 0.05
    temp = 1.0      #change this too
